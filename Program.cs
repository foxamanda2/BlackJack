...
namespace Notes_Week_2
{
    ...
    class Deck
    {
        ...
        static void Displaygame()
            {
                Console.WriteLine();
                Console.WriteLine("Welcome to BlackJack: A Game of Chances, Struggle, and Tears");
                Console.WriteLine();
            }
        ...
        static void Main(string[] args)
        {
            ...
            while(keepPlaying=="y"||keepPlaying=="yes")
            {
                ...
                game2.PlayerCard();
                game2.PlayerCard();
                game2.PrintPlayerCards();
                Console.WriteLine("------------");
                game2.HitStand("Do you want to hit or stand?");
                Console.WriteLine("\n");
                game2.HouseCard();
                game2.HouseCard();
                game2.Houseplay();
